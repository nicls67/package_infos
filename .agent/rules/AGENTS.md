...
The repo contains the `package_infos` library which helps gathering and displaying package metadata.
...
- Update package version after each update, by comparison with the last tag
